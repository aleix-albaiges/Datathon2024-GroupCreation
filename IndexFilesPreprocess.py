...
if __name__ == '__main__':
    ...
    for i, f in enumerate(lfiles):
        ...
        ldocs.append({'_op_type': 'index', '_index': index, 'path': f, 'text': text, 'id': i+1})
        ftxt.close()
    ...
    #client.indices.put_mapping(index=index, properties = {"path": {"type": "keyword"}})

    #client.indices.put_mapping(index=index, mappings = {"properties": {"path": {"type": "keyword"}}})
